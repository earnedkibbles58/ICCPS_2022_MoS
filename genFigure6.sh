...
echo "Running runAEBSScalabilitySMC_baseline.py. This should take around 9 mins."
python3 runAEBSScalabilitySMC_baseline.py
echo "Running runAEBSScalabilitySMC_trimmedbaseline.py. This should take around 9 mins."
python3 runAEBSScalabilitySMC_trimmedbaseline.py
echo "Running runAEBSScalabilitySMCFewSchSamples_trimmedbaseline.py. This should take around 3 mins."
