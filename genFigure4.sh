...
echo "Running runWaterTankDiffDeltaWLs_baseline.py. This should take around 30 mins"
python3 runWaterTankDiffDeltaWLs_baseline.py
echo "Running runWaterTankDiffDeltaWLs_trimmedBaseline.py. This should take around 15 mins"
