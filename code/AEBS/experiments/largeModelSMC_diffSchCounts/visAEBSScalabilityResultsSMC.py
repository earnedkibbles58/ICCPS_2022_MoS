...
def main():
    ...
    print("AEBS: Untrimmed model run times")
    print(run_times_untrimmed)
    print("AEBS: Untrimmed model safety probabilities")
    print(safety_probs_untrimmed)

    print("AEBS: Trimmed model run times")
    print(run_times_trimmed)
    print("AEBS: Trimmed model safety probabilities")
    print(safety_probs_trimmed)

    # print(safety_probs_untrimmed_var)
    # print(safety_probs_trimmed_var)
    ...
    # plt.savefig(IMAGES_FOLDER + '/safetyProbsVariancePlot.png')
    # plt.show()
    # plt.clf()
