...
def main():
    ...
    for init_dist in init_dists:
        ...
        for init_vel in init_vels:
            ...
            for i in range(iter_per_init):
                ...
                proc = subprocess.run([MODEST_PATH, 'simulate',MODEL_FILE,'--lss','Sequential','-L','10','-C','0.8','-W','0.05'], stdout=PIPE, stderr=PIPE)
    ...
    # Save results
    RESULTS_FOLDER = '../../../../results/AEBS/largeModel_SMC/trimmedBaseline_SMC/'
    try:
