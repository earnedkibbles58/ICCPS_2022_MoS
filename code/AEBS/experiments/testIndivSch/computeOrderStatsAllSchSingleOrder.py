...
def main():
    ...
    N_LSS = 5 ## number of samples to use for order stat

    x_lim_lower = 0.98
    x_lim_upper = 1

    ## trimming order
    trimming_order = [0,1,2,3,4,5,6,7] # array of numbers from 0-9, indicating the order of trimming on the model
    ...
    order_str = order_str + "_N_" + str(N_LSS) # name of folder to save plots to
    print(order_str)
    ...
    os_vals_temp,os_probs_temp = computeOrderStatGivenTrimmings(probs,sch,N_LSS,nondet_counts,running_nondet_counts)
