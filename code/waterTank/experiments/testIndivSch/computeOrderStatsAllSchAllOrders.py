...
def main():
    ...
    # trimming_order = [9,8,7,6,5,4,3,2,1,0]
    # trimming_order = [1,0,2,3,4,5,6,7,8,9]
    # trimming_order = [5,1,0,2,3,4,6,7,8,9]


    # trimming_order is an array of numbers, indicating the order of trimming on the model
    trimming_list = list(range(0,len(nondet_counts)))
    all_trimming_orders = list(itertools.permutations(trimming_list))
    # print(all_trimming_orders)
    # print(len(all_trimming_orders))

    for trimming_order in all_trimming_orders:
