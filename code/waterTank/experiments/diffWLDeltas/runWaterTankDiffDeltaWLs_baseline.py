...
def main():
    ...
    # Run PRISM
        ...
        MODEL_FILE = WATER_TANK_BASELINE_FOLDER + 'waterTankBaseline.prism'
    ...
    # Save results
    RESULTS_FOLDER = "../../../../results/waterTank/diffWLDeltas/baseline/if" + str(inflow) + "_of" + str(outflow) + "_numSteps" + str(numSteps) + "/"
    try:
