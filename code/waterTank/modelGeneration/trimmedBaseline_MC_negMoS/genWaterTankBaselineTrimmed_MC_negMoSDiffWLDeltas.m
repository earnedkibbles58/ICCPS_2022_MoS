...
for i=1:length(deltawls)
    ...
    modelFolder = '../../../../models/waterTank/trimmedBaselineMC_negMoS/if' + string(inflow) + '_of' + string(outflow) + '_deltawl' + string(deltawl);
    mkdir(modelFolder)
    modelFile = '../../../../models/waterTank/trimmedBaselineMC_negMoS/if' + string(inflow) + '_of' + string(outflow) + '_deltawl' + string(deltawl) + '/waterTankBaselineMC_negMoS10Steps.prism';
