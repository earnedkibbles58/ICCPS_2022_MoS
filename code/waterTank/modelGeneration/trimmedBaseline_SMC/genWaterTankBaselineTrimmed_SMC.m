...
modelFolder = '../../../../models/waterTank/trimmedBaselineSMC/if' + string(inflow) + '_of' + string(outflow) + '_deltawl' + string(deltawl);
mkdir(modelFolder)
modelFile = '../../../../models/waterTank/trimmedBaselineSMC/if' + string(inflow) + '_of' + string(outflow) + '_deltawl' + string(deltawl) + '/waterTankBaselineSMC.prism';
