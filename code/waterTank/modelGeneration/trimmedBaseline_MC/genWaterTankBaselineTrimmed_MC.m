...
modelFolder = '../../../../models/waterTank/trimmedBaselineMC/if' + string(inflow) + '_of' + string(outflow) + '_deltawl' + string(deltawl);
mkdir(modelFolder)
modelFile = '../../../../models/waterTank/trimmedBaselineMC/if' + string(inflow) + '_of' + string(outflow) + '_deltawl' + string(deltawl) + '/waterTankBaselineMC.prism';
